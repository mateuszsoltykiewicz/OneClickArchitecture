...
BACKEND_KEY="${DR_ROLE}-${ENV_NAME}-infrastructure-state-${AWS_REGION}-${OWNER}.tfstate"
PLAN_FILE="${DR_ROLE}-${ENV_NAME}-infrastructure-plan-${AWS_REGION}-${OWNER}.tfplan"
OUTPUT_FILE="../../configuration/infrastructure/${ENV_NAME}/configuration.json"
