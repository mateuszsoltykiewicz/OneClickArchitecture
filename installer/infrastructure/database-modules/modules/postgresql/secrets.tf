...
resource "random_password" "db_password" {
  ...
  special = false     # Exclude special characters (set to true if allowed by your DB engine)
}
...
# ------------------------------------------------------------------------------
# Usage Notes:
# - Reference aws_secretsmanager_secret.db_credentials.arn or .name to pass the secret to RDS or other resources.
# - Use aws_secretsmanager_secret_version.db_creds_value.secret_string only in secure contexts.
