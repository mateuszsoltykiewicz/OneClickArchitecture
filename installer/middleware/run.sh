...
BACKEND_KEY="${DR_ROLE}-${ENV_NAME}-middleware-state-${AWS_REGION}-${OWNER}.tfstate"
PLAN_FILE="${DR_ROLE}-${ENV_NAME}-middleware-plan-${AWS_REGION}-${OWNER}.tfplan"
OUTPUT_FILE="../../configuration/middleware/${ENV_NAME}/configuration.json"
